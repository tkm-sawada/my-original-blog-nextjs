...
const Layout: FC<Props> = ({ children, categories }) => {
  ...
  return (
    <div className="font-body bg-[#eeeeee]">
      <Head>
              ...
              {menuList.map((menu: Menu, i: number) => {
                return (
                  <li key={i} className="py-4 border-b">
                    <Link href={menu.url}><a className="w-full block" onClick={menuFunction}>{menu.name}</a></Link>
                  </li>
                );
              })}
            </ul>
        ...
        <div className="md:w-1/4 w-full md:mt-0 mt-16 md:p-0 px-4">
          <aside className="border p-4 mb-8 bg-white">
            ...
            <div className="py-4 text-sm">
              ...
              ものづくりが大好きです。<br/>
              <br/>
              主にコーディングやプログラミングなど、自分が学んだ内容を投稿します。<br/>
              <br/>
              【使用言語】<br/>
              PHP、Python、HTML、CSS、JavaScript、jQuery、VB.Net、Java、Go(少し)<br/>
              <br/>
              【フレームワーク】<br/>
              React(Next.js)、Laravel<br/>
              <br/>
              【取得資格】<br/>
